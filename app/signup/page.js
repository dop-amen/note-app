  ...
  return (
    <>
      <style>{`
        ...
        .neu-input::placeholder { color: var(--text-dim); }
        ...
        .rip1.active { animation: waves 1s linear forwards; }
        .rip2.active {
          box-shadow: 0.4rem 0.4rem 0.8rem var(--shadow-dark), -0.4rem -0.4rem 0.8rem var(--shadow-light);
        ...
        .neu-links a:hover { color: var(--green-accent); }
      ...
      <div className="neu-body">
        <form onSubmit={handleSignup} className="neu-card">
          <span className="neu-title">Create account</span>
          ...
          {message && <p className="neu-message">{message}</p>}

          <div className="neu-btn-wrap">
            <button type="submit" className="neu-btn">Sign Up</button>
